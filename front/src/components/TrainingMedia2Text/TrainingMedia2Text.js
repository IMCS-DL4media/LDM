...
export default{	 
    ...
    methods: {
        ...
        getData: function() {
            ...
            console.log("self.filePath ", self.filePath + '/' + self.projectId + '/' + self.runId + "/" + self.id)

            axios.get(self.SERVER_URL() + self.filePath + '/' + self.projectId + '/' + self.runId + "/" + self.id)
                .then(function(response) {
                    ...
                    _.extend(self.media, {_id: self.getId(self.media), path: path,});
        ...
        runChanged: function(ev) {
            ...
            this.$router.push({name: "AudioTranscription", params: {projectId: this.projectId,
                                                                        runId: this.runId,
                                                                        id: this.id,
                                                                    }});
        },
