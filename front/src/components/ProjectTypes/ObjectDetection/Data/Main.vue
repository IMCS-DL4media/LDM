			...
			<div class="tab-content">
				<div class="tab-pane fade show active" id="tab-data">
					...
					<ul class="nav nav-tabs" id="myTab" role="tablist">
						...
						<li class="nav-item">
							<router-link id="all-data-tab" data-toggle="tab" class="nav-link" :class="activeTab.DataObjectDetectionAllData" :to="{ name: 'DataObjectDetectionAllData', params: {project_id: projectId, }}" role="tab" aria-controls="all-data" aria-selected="false">
							All data
							</router-link>
						</li>

<!-- 						<li class="nav-item">
							<router-link id="training-data-tab" data-toggle="tab" class="nav-link" :class="activeTab.DataObjectDetectionAllData" :to="{ name: 'DataImageClassificationTrainingData', params: {project_id: projectId, }}" role="tab" aria-controls="training-data" aria-selected="true">
							Training data
							</router-link>
						</li>

						<li class="nav-item">
							<router-link id="validate-data-tab" data-toggle="tab" class="nav-link" :class="activeTab.DataObjectDetectionAllData" :to="{ name: 'DataImageClassificationValidateData', params: {project_id: projectId, page_nr: 1}}" role="tab" aria-controls="test-data" aria-selected="true">
							Validation data
							</router-link>
						</li>
